# pocket-tts Archify Architecture
...
- Repository URL: https://github.com/hundong2/pocket-tts.git
- Checkout SHA: 5b0cd9ff65036b38d1bb21314e6839cb28f31d75
- README file: README_kor.md
- Evidence file: README_kor.md
- README title: Pocket TTS
- Dependency markers: Python, uv
- Top-level directories: .pytest_cache, .venv, docs, guide, pocket_tts, scripts, tests
- Category: OCR, document, and media AI

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for pocket-tts.
...
주 경로는 `Developer / learner -> README and docs -> Setup and deps -> Entry points -> OCR / parser core -> Text / structured data`이다.
